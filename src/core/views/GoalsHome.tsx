            ...
            <div className="flex items-center justify-between pb-2 border-b border-slate-800/80">
              <div className="flex items-center gap-2">
                <button onClick={onOpenProfile} className="relative group cursor-pointer" title="Ver Perfil">
                  <div className="w-10 h-10 rounded-full bg-slate-900 border-2 border-indigo-500 flex items-center justify-center text-xl shadow-[0_0_10px_rgba(99,102,241,0.4)] group-hover:scale-105 transition-transform overflow-hidden">
                ...
                {MINI_APPS.map((app) => {
                  ...
                  return (
                    <div
                      ...
                      className={`bg-gradient-to-br ${app.bgGradientClass} border ${app.borderClass} rounded-2xl p-3 cursor-pointer transition-all hover:scale-[1.02] active:scale-95 shadow-md flex flex-col justify-between group`}
                    >
                      <div className="flex items-start justify-between">
                        <div className={`p-2 rounded-xl bg-slate-950 border border-slate-800 group-hover:scale-110 transition-transform ${app.iconColorClass}`}>
                          <IconComp className="w-5 h-5" />
                        </div>
                        <span className={`px-2 py-0.5 rounded-full border text-[9px] font-bold ${app.badgeClass}`}>
                          {app.badge}
                        </span>
                      </div>
