...
const updateServiceContent = Buffer.from(`/**
...
const modalContent = Buffer.from(`import React, { useState, useEffect } from 'react';
...
echo "${updateServiceContent}" | base64 -d > src/services/updateService.js
echo "${modalContent}" | base64 -d > src/components/ApkDownloadGuideModal.jsx
echo "SUCCESS_FILES_WRITTEN"
`;
